...
const HEADER_ALIASES = {
  ...
  recommended_replacement_date: 'recommendedReplacementDate',
  recommended_replace_date: 'recommendedReplacementDate',
  manufacturer_replacement_date: 'recommendedReplacementDate',
  lifecycle: 'lifecycle',
